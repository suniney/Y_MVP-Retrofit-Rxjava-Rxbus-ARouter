...
import com.chinaso.so.basecomponent.constant.ConstantShare;
...
public class ShareDialog extends Dialog implements View.OnClickListener {
    ...
    private void init() {
        ...
        list.add(new ShareEntity(R.mipmap.ico_share_qq, ConstantShare.SHARE_QQ));
        list.add(new ShareEntity(R.mipmap.ico_share_qqkj, ConstantShare.SHARE_QQ_SPACE));
        list.add(new ShareEntity(R.mipmap.ico_share_wb, ConstantShare.SHARE_WB));
        list.add(new ShareEntity(R.mipmap.ico_share_wxpyq, ConstantShare.SHARE_WX_FRIENDS));
        list.add(new ShareEntity(R.mipmap.ico_share_wx, ConstantShare.SHARE_WX));
        list.add(new ShareEntity(R.mipmap.ico_share_link, ConstantShare.SHARE_LINK));
